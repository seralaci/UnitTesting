...
public class ValueSamplesTests
{
    ...
    public void DateAssertionExample()
    {
        ...
        dateOfBirth.Should().BeAfter(new(2000, 1, 1)).And.BeBefore(new(2001, 1, 1));
        dateOfBirth.Should().BeAfter(new(2000, 1, 1));
    }
    ...
    public void EnumerableObjectsAssertionExample()
    {
        ...
        users.Should().Contain(x => x.FullName.StartsWith("John") && x.Age > 5);
    }
